...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Advanced" class="row text-center" onclick="window.location = '/Advanced/AOne.aspx'">
        ...
        <div class="pad">
            ...
            <p>Need no for guidance, jump in and practice what you've learned. A true master of Bootstrap in the making, returned for old times. Be bold, try something new!</p>
            <p>
