    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-10">
                    <p>
                        If we recall our example in chapter 3, it used <code>col-md-4</code>, to define 3 columns of width 4 of 12. The <code>md</code>
                    ...
                    if we open the same example page using a smaller screen size, we see the columns display differently.
                    </p>
                    <p>
                        <input type="button" value="View example" class="btn btn-primary" onclick="window.open('Example.html', '_blank', 'width=800, height=600', 'false')" /></p>
                    <p>
...
&lt;/html&gt;
                    ...
                    <p>
                        ...
                        defaults to the natural flow of the page, downwards.
                    </p>
                    <p>
                        <input type="button" value="View example" class="btn btn-primary" onclick="window.open('Example2.html', '_blank', 'width=800, height=600', 'false')" /></p>
